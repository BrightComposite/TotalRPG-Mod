...
public class AQHungerIndicator extends AQGuiIndicator
{
	static final ResourceLocation image = new ResourceLocation(AQModInfo.MODID + ":" + "textures/gui/indicators/hunger.png");
	
	@Override
	public void draw(Minecraft mc, int x, int y)
	{
		float[] color = getColor(AQThisPlayerWrapper.getWrapper().hunger.getPercent());
	...
	{
		return I18n.format("indicator.hunger" + level);
	}
}
