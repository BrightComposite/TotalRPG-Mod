...
public class AQThirstIndicator extends AQGuiIndicator
{
	static final ResourceLocation image = new ResourceLocation(AQModInfo.MODID + ":" + "textures/gui/indicators/thirst.png");
	
	@Override
	public void draw(Minecraft mc, int x, int y)
	{
		float[] color = getColor(AQThisPlayerWrapper.getWrapper().thirst.getPercent());
	...
	{
		return I18n.format("indicator.thirst" + level);
	}
}
