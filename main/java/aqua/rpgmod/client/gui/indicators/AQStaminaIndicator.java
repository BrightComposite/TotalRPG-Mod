...
public class AQStaminaIndicator extends AQGuiIndicator
{
	static final ResourceLocation image = new ResourceLocation(AQModInfo.MODID + ":" + "textures/gui/indicators/stamina.png");
	
	@Override
	public void draw(Minecraft mc, int x, int y)
	{
		float[] color = getColor(AQThisPlayerWrapper.getWrapper().stamina.getPercent());
	...
	{
		return I18n.format("indicator.stamina" + level);
	}
}
