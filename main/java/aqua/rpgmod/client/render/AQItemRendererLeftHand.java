...
public class AQItemRendererLeftHand extends ItemRenderer
{
	...
	public AQItemRendererLeftHand(Minecraft mc)
	{
		super(mc);
	...
	public void renderItemInFirstPerson(float p_78440_1_)
	{
		...
		GL11.glRotatef(
			entityclientplayermp.prevRotationYaw + (entityclientplayermp.rotationYaw - entityclientplayermp.prevRotationYaw) * p_78440_1_,
			0.0F,
			1.0F,
			0.0F);
		...
		if(itemstack != null && itemstack.getItem() instanceof ItemMap)
		{
			GL11.glPushMatrix();
			f13 = 0.8F;
			f5 = 0.0f; // entityclientplayermp.getSwingProgress(p_78440_1_);
			...
			f6 = 0.0f; // entityclientplayermp.getSwingProgress(p_78440_1_);
			...
			{
				custom.renderItem(FIRST_PERSON_MAP, itemstack, this.mc.thePlayer, this.mc.getTextureManager(), mapdata);
			}
	...
	public void updateEquippedItem()
	{
		...
		if(itemstack != null && this.itemToRender != null && itemstack != this.itemToRender && itemstack.getItem() == this.itemToRender.getItem()
